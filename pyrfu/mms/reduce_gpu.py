...
from ..pyrf.int_sph_dist_gpu import int_sph_dist_gpu
...
def reduce_gpu(vdf, xyz, dim: str = "1d", base: str = "pol", **kwargs):
    ...
    **kwargs
    ...
    for i_t in tqdm.tqdm(range(n_t), ncols=60):  # display progress
        ...
        tmpst = int_sph_dist_gpu(f_3d, speed, phi, theta, speed_grid, **options)
